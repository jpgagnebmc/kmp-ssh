...
external interface HttpBase {
    ...
    fun setTimeout(): HttpBase /* this */
    fun setTimeout(msecs: Number = definedExternally): HttpBase /* this */
...
external open class ServerResponse(req: IncomingMessage) : OutgoingMessage {
    ...
    open fun writeHead(statusCode: Number, reasonPhrase: String = definedExternally): ServerResponse /* this */
    open fun writeHead(statusCode: Number, reasonPhrase: String = definedExternally, headers: Array<Any /* Number | String | Array<String> */> = definedExternally): ServerResponse /* this */
