...
external fun parse(urlStr: String, parseQueryString: Boolean?): UrlWithStringQuery
...
external fun parse(urlStr: String, parseQueryString: Boolean): dynamic /* UrlWithParsedQuery | Url */
