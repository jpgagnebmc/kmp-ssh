...
external open class internal : EventEmitter {
    open fun <T : WritableStream> pipe(destination: T, options: `T$8` = definedExternally): T
    ...
    interface WritableOptions {
        ...
        val writev: ((chunks: Array<`T$20`>, callback: (error: Error?) -> Unit) -> Unit)?
        val destroy: ((error: Error?, callback: (error: Error?) -> Unit) -> Unit)?
    ...
    open class Writable(opts: WritableOptions = definedExternally) : Stream, WritableStream {
        ...
        open val _writev: ((chunks: Array<`T$20`>, callback: (error: Error?) -> Unit) -> Unit)?
        open val _construct: ((callback: (error: Error?) -> Unit) -> Unit)?
        open fun _destroy(error: Error?, callback: (error: Error?) -> Unit)
        ...
        open fun write(chunk: Any, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, cb: (error: Error?) -> Unit = definedExternally): Boolean
    ...
    interface DuplexOptions : ReadableOptions, WritableOptions {
        ...
        override val writev: ((chunks: Array<`T$20`>, callback: (error: Error?) -> Unit) -> Unit)?
