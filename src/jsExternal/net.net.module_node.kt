...
external open class Socket(options: SocketConstructorOpts = definedExternally) : Duplex {
    ...
    open fun end(str: Uint8Array, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally, cb: () -> Unit = definedExternally)
    ...
    open fun end(str: String, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally, cb: () -> Unit = definedExternally)
