...
external open class MessagePort : EventEmitter {
    open fun close()
    open fun postMessage(value: Any, transferList: Array<Any /* ArrayBuffer | MessagePort | FileHandle */> = definedExternally)
    open fun ref()
    open fun unref()
    open fun start()
...
external interface WorkerOptions {
    ...
    var resourceLimits: ResourceLimits?
        get() = definedExternally
        set(value) = definedExternally
    var transferList: Array<dynamic /* ArrayBuffer | MessagePort | FileHandle */>?
        get() = definedExternally
        set(value) = definedExternally
...
external fun receiveMessageOnPort(port: MessagePort): `T$75`?