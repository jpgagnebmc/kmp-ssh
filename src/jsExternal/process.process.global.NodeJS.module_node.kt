...
import domain.global.NodeJS.Domain
...
external interface Process : EventEmitter {
    ...
    var hrtime: HRTime
    var domain: Domain
    val send: ((message: Any, sendHandle: Any, options: `T$17`, callback: (error: Error?) -> Unit) -> Boolean)?
    fun disconnect()
    ...
    fun addListener(event: String /* "newListener" | "removeListener" */, listener: NewListenerListener): Process /* this */
    ...
    fun on(event: String /* "newListener" | "removeListener" */, listener: NewListenerListener): Process /* this */
    ...
    fun once(event: String /* "newListener" | "removeListener" */, listener: NewListenerListener): Process /* this */
    ...
    fun prependListener(event: String /* "newListener" | "removeListener" */, listener: NewListenerListener): Process /* this */
    ...
    fun prependOnceListener(event: String /* "newListener" | "removeListener" */, listener: NewListenerListener): Process /* this */
