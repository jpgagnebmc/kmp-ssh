...
external fun addListener(event: String /* "message" */, listener: (worker: Worker, message: Any, handle: Any /* net.Socket | net.Server */) -> Unit): Cluster
...
external fun on(event: String /* "message" */, listener: (worker: Worker, message: Any, handle: Any /* net.Socket | net.Server */) -> Unit): Cluster
...
external fun once(event: String /* "message" */, listener: (worker: Worker, message: Any, handle: Any /* net.Socket | net.Server */) -> Unit): Cluster
...
external fun prependListener(event: String /* "message" */, listener: (worker: Worker, message: Any, handle: Any /* net.Socket | net.Server */) -> Unit): Cluster
...
external fun prependOnceListener(event: String /* "message" */, listener: (worker: Worker, message: Any, handle: Any /* net.Socket | net.Server */) -> Unit): Cluster
